...
def is_always_roll(strategy, goal=GOAL):
    ...
    # isAlways = True
    # score0 = 0
    # roll = strategy(score0, 0)
    # while score0 < goal:
    #     score1 = 0
    #     while score1 < goal:
    #         if strategy(score0, score1) != roll:
    #             isAlways = False
    #         score1 += 1
    #     score0 += 1
    # return isAlways
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    def highest_average_roll():
        count = 1
        highest_roll = 0
        while count <= 10:
            averaged_roll_dice = make_averaged(roll_dice, total_samples)
            roll = averaged_roll_dice(count, dice)
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    tail = tail_points(opponent_score)  
    new_score = score
    new_score = square_update(0, new_score, opponent_score)
